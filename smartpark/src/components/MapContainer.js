...
const MapContainer = ({ parkingSpots, routeStart, routeEnd, searchedLocation }) => {
  const defaultPosition = searchedLocation ? [searchedLocation.latitude, searchedLocation.longitude] : [-1.286389, 36.817223];
